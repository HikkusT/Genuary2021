		...
		SubShader
	{
		...
		Pass
		{
			...
			void Geometry(triangleadj v2f i[6], inout TriangleStream<g2f> stream)
			{
				...
				float edge1 = distance(i[0].originalPos, i[1].originalPos);
				float edge2 = distance(i[1].originalPos, i[2].originalPos);
				float edge3 = distance(i[2].originalPos, i[0].originalPos);
